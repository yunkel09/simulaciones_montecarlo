...
knit_hooks$set(document = function(x) {sub('\\usepackage[]{color}', 
 ...
 pacman::p_load(skimr, triangle, scales, fitdistrplus, tidyverse)
...
% # <<child='secciones/01_marco_teorico.Rnw'>>=
% # 
% # @

 

% # <<motor, child='secciones/02_motor.Rnw'>>=
% # 
% # @

% # <<mandrell, child='secciones/03_mandrell.Rnw'>>=
% # 
% # @


<<producto, child='secciones/04_producto.Rnw'>>=

@


<<bib, child='secciones/05_bibliografia.Rnw'>>=
